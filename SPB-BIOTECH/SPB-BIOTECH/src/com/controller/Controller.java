	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (page.equals("sign-up-form")) {
			...
			if (password_1.equals(password_2)) {
				...
				request.setAttribute("msg", "Password not marched, Please enter Again..!");
		...
		if (page.equals("organic") || page.equals("phosphate") || page.equals("potassium") || page.equals("nitrogenous")
			...
			if (page.equals("organic"))
				request.getRequestDispatcher("organic.jsp").forward(request, response);
			if (page.equals("phosphate"))
				request.getRequestDispatcher("phosphate.jsp").forward(request, response);
			if (page.equals("potassium"))
				request.getRequestDispatcher("potassium.jsp").forward(request, response);
			if (page.equals("nitrogenous"))
				request.getRequestDispatcher("nitrogenous.jsp").forward(request, response);
		...
		if (page.equals("addtocart")) {
			...
			if (action.equals("allproducts"))
				request.getRequestDispatcher("all-products.jsp").forward(request, response);
			if (action.equals("potassium"))
				request.getRequestDispatcher("potassium.jsp").forward(request, response);
			if (action.equals("nitrogenous"))
				request.getRequestDispatcher("nitrogenous.jsp").forward(request, response);
			if (action.equals("phosphate"))
				request.getRequestDispatcher("phosphate.jsp").forward(request, response);
			if (action.equals("organic"))
				request.getRequestDispatcher("organic.jsp").forward(request, response);
		}
