 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
						 ...
						 <a href="Controller?page=all-products" class="list-group-item" style="background:  #d6d4d3;">
						  ...
						  <a href="Controller?page=organic" class="list-group-item">Organic Fertilizer</a>
						  <a href="Controller?page=phosphate" class="list-group-item">Phosphate Fertilizer</a>
						  <a href="Controller?page=potassium" class="list-group-item">Potassium Fertilizer</a>
						  <a href="Controller?page=nitrogenous" class="list-group-item">Nitrogenous Fertilizer</a>
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Organic Fertilizer</h2><br>
...
<!-- 					<input type="hidden" name="action" value="organic"> -->
<!-- 					<select name="sort"> -->
...
<!-- 					</form> -->
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'organic' }">
		 					...
		 					<div class="col-md-4">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=organic&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>
		 					</div>
	...
	<footer>
		<div class="footer"> &copy; 2018 Copyright:
	      <a href="Controller?page=index"> SPB BIOTECH</a>
	    </div>
	</footer>
