 				...
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  <a href="Controller?page=all-products" class="list-group-item" style="background:  #d6d4d3;">
						    Fertilizers Categories
						  </a>
						  <br><a href="Controller?page=organic" class="list-group-item">Organic Fertilizers</a><br>
						  <a href="Controller?page=phosphate" class="list-group-item">Phosphate Fertilizers</a><br>
						  <a href="Controller?page=potassium" class="list-group-item">Potassium Fertilizers</a><br>
						  <a href="Controller?page=nitrogenous" class="list-group-item">Nitrogenous Fertilizers</a><br>
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Contact Information</h2><br>
 					<h3 style="text-align: center;">Pradeep Bhardwaj</h3>
 					<h4 style="text-align: center;">Alipur, Delhi</h4>
 					<h4 style="text-align: center;">+91 8274298347</h4>
 					<h4 style="text-align: center;">pradeep_bhardwaj1@india.com</h4>
<!-- 					<h5>Sort by(Price):</h5> -->
...
<%--  					</c:forEach> --%>
 				...
 				<div class="about-media">
 					<img alt="" src="img/fertilizer.jpg">
 				</div>
 				</div>
 			</div>
 		</div>
