 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="Controller?page=organic" class="list-group-item">Organic Fertilizers</a>
						  <a href="Controller?page=phosphate" class="list-group-item">Phosphate Fertilizers</a>
						  <a href="Controller?page=potassium" class="list-group-item">Potassium Fertilizers</a>
						  <a href="Controller?page=nitrogenous" class="list-group-item">Nitrogenous Fertilizers</a>
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Potassium Fertilizers</h2><br>
...
<!-- 					</form> -->
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'potassium' }">
