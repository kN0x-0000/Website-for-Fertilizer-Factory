...
<header>
	...
	<div class="signup-header">
	 	<h2>Login to <mark>SPB BIOTECH</mark></h2>
	</div>
	 ...
	 <input type="hidden" name="page" value="login-form">
	 	...
	 	<div class="signup-group">
	 		...
	 		<input type="text" name="username" placeholder="Enter Your Username" value="<c:out value="${username }"></c:out>">
	 	</div>
	 	<div class="signup-group">
	 	...
	 	<p>
	 		New Here? <a href="Controller?page=sign-up" style="color:#F24638;">Create Account</a>
	 	</p>
	 </form>
	<br><br><br>
