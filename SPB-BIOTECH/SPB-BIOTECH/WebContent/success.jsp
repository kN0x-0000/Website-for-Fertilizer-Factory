...
<body>
	...
	<c:choose>
		...
		<c:when test="${x == 0}">
				...
				<%
				JOptionPane.showMessageDialog(null, "Your shopping Cart is empty", "Info", JOptionPane.INFORMATION_MESSAGE);
		...
		<c:when test="${session != null}">
				...
				<div class="container" style="margin-top: 60px;margin-bottom: 60px;">
					<h4>Thank you <font color="#6bb1f8"><c:out value="${name }"></c:out></font> We have received your order request. Your order will be processed within 24hours.</h4>
