 		...
 		<div class="row">
 				<div class="col-md-4"><!-- left -->
 						<div class="list-group"><!-- products -->
						  ...
						  <a href="Controller?page=organic" class="list-group-item">Organic</a>
						  <a href="Controller?page=phosphate" class="list-group-item">Phosphate</a>
						  <a href="Controller?page=potassium" class="list-group-item">potassium</a>
						  <a href="Controller?page=nitrogenous" class="list-group-item">Nitrogenous</a>
						</div> 
 				</div><!-- left -->

 				<div class="col-md-8"><!-- right -->
 					<h2 style="text-align: center;">Nitrogenous Fertilizer</h2><br>
...
<!-- 					</form> -->
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getCategory() == 'nitrogenous' }">
		 					...
		 					<div class="col-md-4">
								...
								<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=home-decor&id=<c:out value="${product.getId()}"/>">Add to Cart</a> </div><br>		 					
								</div>
