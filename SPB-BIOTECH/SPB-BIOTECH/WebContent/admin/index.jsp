...
<body>
	<header>
	 ...
	 <sql:setDataSource user="root" password="root" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mysql://localhost:3306/fertilizers?autoReconnect=true&useSSL=false" var="ds"/>
		 ...
		 <c:forEach items="${result.rows }" var="row">
		  <table style="table-layout: fixed;width: 100%;">
				...
				<tr>
					...
					<td style="width: 100px;"><img src="${row.image}" height="150" width="150" ></td>
